...
class domain(object):
    ...
    def __init__(self, model, domain=None, data=None, set_mean=None):
        ...
        # set model from a gempy_lite solution
        ...
        # TODO: Maybe also allow to pass a gempy_lite regular grid object
        if domain is None:
    ...
    def set_domain(self, domain):
        ...
        Args:
            domain (np.array)(x,) = array containing all surfaces of interest from the gempy_lite model that
...
def create_kriged_field(domain, variogram_model, distance_type='euclidian',
    ...
    '''
    Method to create a kriged field over the defined grid of the gempy_lite solution depending on the defined
