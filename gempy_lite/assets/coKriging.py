"""
    ...
    gempy_lite is free software: you can redistribute it and/or modify
    it under the terms of the GNU General Public License as published by
    the Free Software Foundation, either version 3 of the License, or
    (at your option) any later version.

    gempy_lite is distributed in the hope that it will be useful,
    but WITHOUT ANY WARRANTY; without even the implied warranty of
    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
    GNU General Public License for more details.

    You should have received a copy of the GNU General Public License
    along with gempy_lite.  If not, see <http://www.gnu.org/licenses/>.
...
class SGS(object):
    ...
    def select_segmented_grid(self, grid=None, df=None, litho=None, block=None):
        ...
        Args:
            ...
            block (numpy.array): 3D block model generated by gempy_lite
        ...
        # Translate lithology name to lithology number, i.e. the value of the lithology in the gempy_lite block
        litho_num = df['Lithology Number'][df["Lithology"] == litho].iloc[0]

        # Extract from the grid the XYZ coordinates where the gempy_lite block model is the given lithology
        segm_grid = grid[block == litho_num]
    ...
    def set_grid_to_inter(self, grid):
        ...
        Grid setter
        Args:
            grid (numpy.array): Grid object from gempy_lite with the points of interest of the model
        """
    ...
    def set_geomodel(self, geomodel):
        """
        gempy_lite model setter
        Args:
            geomodel (numpy.array): gempy_lite block model
        """
        self.geomodel = geomodel
