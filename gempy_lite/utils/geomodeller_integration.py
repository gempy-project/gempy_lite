...
# TODO fix this function and importing it to gempy_lite.utils.create_from_geomodeller_xml
...
def read_vox(geo_data, path):
    """
    read vox from geomodeller and transform it to gempy_lite format
    Returns:
