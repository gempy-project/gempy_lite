...
def change_input_data_general(data_array, interp_data):
    ...
    Args:
        ...
        interp_data (gempy_lite.data_management.InterpolationData): An interp_data object with the structure we want to
        compute.
...
def change_input_data(db, interp_data, i):
    ...
    Returns:
         gempy_lite.data_management.InterpolationData: interp_data with the data of the given iteration
    """
    i = int(i)
    # replace interface data
