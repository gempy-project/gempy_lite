...
from gempy_lite.core.data import Grid, Surfaces, AdditionalData
from gempy_lite.core.data_modules.geometric_data import  SurfacePoints, Orientations
from gempy_lite.core.data_modules.stack import Faults, Series
...
class Interpolator(object):
    ...
    def create_theano_graph(self, additional_data: "AdditionalData" = None, inplace=True,
        ...
        import gempy_lite.core.theano_modules.theano_graph_pro as tg
        import importlib
        importlib.reload(tg)
...
class InterpolatorMagnetics:
    ...
    def calculate_V(self, centered_grid):
        from gempy_lite.assets.geophysics import MagneticsPreprocessing
