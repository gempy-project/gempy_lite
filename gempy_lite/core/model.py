...
class ImplicitCoKriging(object):
    ...
    @property
    def grid(self):
        """ :class:`gempy_lite.core.data.Grid` [s0]
    ...
    @property
    def surfaces(self):
        """:class:`gempy_lite.core.data.Surfaces` [s0]"""
    ...
    def additional_data(self):
        """:class:`gempy_lite.core.data.AdditionalData` [s0]"""
    ...
    def update_structure(self, update_theano=None, update_series_is_active=True,
        ...
        Returns:
            :class:`gempy_lite.core.data.Structure`
        """
    ...
    def set_active_grid(self, grid_name: Union[str, Iterable[str]], reset=False):
        ...
        Returns:
            :class:`gempy_lite.core.data.Grid`
    ...
    def set_regular_grid(self, extent, resolution):
        ...
        See Also:
            :class:`gempy_lite.core.data.Grid.create_regular_grid`

            :class:`gempy_lite.core.data.grid_modules.grid_types.RegularGrid`
    ...
    def set_custom_grid(self, custom_grid):
        ...
        See Also:
            :class:`gempy_lite.core.data.Grid.create_custom_grid`

            :class:`gempy_lite.core.data.grid_modules.grid_types.CustomGrid`
    ...
    def set_topography(self, source='random', set_mask=True, **kwargs):
        ...
        See Also:
            :class:`gempy_lite.core.grid_modules.grid_types.Topography`
    ...
    def set_centered_grid(self, centers, radius, resolution=None):
        ...
        See Also:
            :class:`gempy_lite.core.grid_modules.grid_types.CenteredGrid`
    ...
    def set_section_grid(self, section_dict):
        ...
        Returns:
            :class:`gempy_lite.core.grid_modules.grid_types.Sections`
...
class Project(ImplicitCoKriging):
    ...
    def load_model_pickle(path):
        ...
        Returns:
            :class:`gempy_lite.core.model.Model`
    ...
    def get_data(self, itype='data', verbosity=0, numeric=False):
        ...
        :class:`gempy_lite.core.model.Project` data object.
