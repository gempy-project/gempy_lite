...
from gempy_lite.core.grid_modules import grid_types
...
class Grid(object):
    ...
    Keyword Args:
         ...
         topography (:class:`gempy_lite.core.grid_modules.grid_types.Topography`): [s2]
         sections (:class:`gempy.core.grid_modules.grid_types.Sections`): [s3]
         gravity (:class:`gempy_lite.core.grid_modules.grid_types.Gravity`):
    ...
    Attributes:
        ...
        topography (:class:`gempy_lite.core.grid_modules.grid_types.Topography`)
        sections (:class:`gempy.core.grid_modules.grid_types.Sections`)
        gravity_grid (:class:`gempy_lite.core.grid_modules.grid_types.Gravity`)
    """
    ...
    def create_topography(self, source='random', **kwargs):
        ...
        Returns:
             :class:gempy_lite.core.data.Topography
        """
