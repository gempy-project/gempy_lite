...
class Solution(object):
    ...
    def set_solution_to_regular_grid(self, values: Union[list, np.ndarray],
        ...
        Args:
            values (list[np.array]): list with result of the theano evaluation (values returned by
             :func:`gempy_lite.compute_model` function):
        ...
        Returns:
            :class:`gempy_lite.core.solutions.Solutions`
    ...
    def set_values_to_regular_grid(self, values: Union[list, np.ndarray]):
        ...
        Args:
            values (np.ndarray): values returned by `function: gempy_lite.compute_model` function
    ...
    def compute_all_surfaces(self, **kwargs):
        ...
        See Also:
            :meth:`gempy_lite.core.solution.Solution.compute_marching_cubes_regular_grid`
