...
def set_geometric_data(geo_model: Model, surface_points_df=None,
    ...
    """ Function to set directly pandas.Dataframes to the gempy_lite geometric data objects
...
def set_orientation_from_surface_points(geo_model, indices_array):
    """
    Create and set orientations from at least 3 points of the :attr:`gempy_lite.data_management.InputData.surface_points`
     Dataframe
